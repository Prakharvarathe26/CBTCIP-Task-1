...
public class ChangeCredentialsPage extends JFrame implements ActionListener {
    ...
    public ChangeCredentialsPage() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(ChangeCredentialsPage.class.getResource("icon.png"))); // Change the icon
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == saveButton) {
            ...
            try {
                PrintWriter writer = new PrintWriter(new File(LoginPage.class.getResource("credentials.txt").getPath()));
